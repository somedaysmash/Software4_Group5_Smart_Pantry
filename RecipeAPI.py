...
def get_random_recipe(query):
    api_endpoint=(f'https://api.edamam.com/api/recipes/v2?type=public&app_id={app_id}&app_key={app_key}&q={query}&/random=true&field=label&field=ingredients&field=totalWeight')
    try:
