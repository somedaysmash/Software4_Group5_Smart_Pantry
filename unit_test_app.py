...
from App import welcome, kitchen, ingredient, delete_item_from_stock

# missing tests = file_download_missing, generate_shopping_list, upload_shoppinglist, file_downloads, search_recipe,
# see_more_recipes, out_of_date_ingredients, add_stock, add_stock_submit
...
class TestKitchenRoute(unittest.TestCase):
    def test_kitchen_route(self):
        client = app.test_client()
        response = client.post('/kitchen', data={'stock_store': 'Fridge', 'itemName': 'item1',
